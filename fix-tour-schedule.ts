...
import { events, eventTimeslots, ticketOrders, memberships, donations } from "./drizzle/schema";
...
async function main() {
  ...
  //    Range: Apr 8, 2026 through Dec 14, 2026
  const tourTimes = [
  ...
  const validDays = new Set([0, 5, 6]); // Sunday, Friday, Saturday

  const startDate = new Date("2026-04-08T12:00:00");
  const endDate = new Date("2026-12-14T12:00:00");
