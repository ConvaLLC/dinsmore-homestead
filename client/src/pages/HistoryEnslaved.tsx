    ...
    <div className="min-h-screen" style={{ background: "oklch(97.8% 0.008 89.6)" }}>
      <div className="relative py-20 text-center" style={{ backgroundImage: `linear-gradient(rgba(44,26,12,0.8), rgba(44,26,12,0.8)), url(${FALLBACK_IMG})`, backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="container">
          <p className="section-label" style={{ color: "oklch(74.2% 0.118 90.2)" }}>Honoring Their Memory</p>
          ...
          <p style={{ color: "oklch(87.6% 0.068 89.7)", fontFamily: "'EB Garamond', serif", fontSize: "1.1rem", maxWidth: "640px", margin: "0 auto 1.5rem" }}>
      ...
      {selectedProfile && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: "rgba(44,26,12,0.88)" }} onClick={() => setSelected(null)}>
          <div className="max-w-2xl w-full max-h-[85vh] overflow-y-auto rounded-sm shadow-2xl" style={{ background: "oklch(97.8% 0.008 89.6)", border: "2px solid oklch(74.2% 0.118 90.2)" }} onClick={e => e.stopPropagation()}>
            <div className="p-8">
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.6rem", color: "oklch(21.8% 0.036 251.3)", marginBottom: "0.25rem" }}>{selectedProfile.name}</h2>
              <p style={{ color: "oklch(74.2% 0.118 90.2)", fontStyle: "italic", marginBottom: "1.5rem", fontSize: "0.9rem" }}>{selectedProfile.years}</p>
      ...
      <div className="container py-16">
        <div className="max-w-3xl mx-auto mb-14">
          <div className="text-center mb-8">
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.8rem", color: "oklch(21.8% 0.036 251.3)", marginBottom: "0.5rem" }}>A Complete History</h2>
        ...
        <div className="mb-14">
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.6rem", color: "oklch(21.8% 0.036 251.3)", marginBottom: "1.5rem", textAlign: "center" }}>Documented Individuals</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {KEY_PROFILES.map(profile => (
              <button key={profile.slug} onClick={() => setSelected(profile.slug)} className="group text-left p-6 bg-white hover:bg-[oklch(55%_0.11_72_/_0.05)] transition-colors" style={{ border: "1px solid oklch(55% 0.11 72 / 0.3)" }}>
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.1rem", color: "oklch(21.8% 0.036 251.3)", marginBottom: "0.25rem" }} className="group-hover:text-[oklch(55%_0.11_72)] transition-colors">{profile.name}</h3>
                <p style={{ fontSize: "0.8rem", color: "oklch(74.2% 0.118 90.2)", fontStyle: "italic", marginBottom: "0.75rem" }}>{profile.years}</p>
                <p style={{ fontFamily: "'EB Garamond', serif", fontSize: "0.9rem", color: "oklch(47.2% 0.088 247.4)", lineHeight: 1.6, display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{profile.bio.slice(0, 200)}…</p>
                <span style={{ display: "inline-block", marginTop: "0.75rem", fontSize: "0.75rem", color: "oklch(74.2% 0.118 90.2)", textDecoration: "underline" }}>Read full profile →</span>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-14 p-8 bg-white" style={{ border: "1px solid oklch(55% 0.11 72 / 0.3)" }}>
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.3rem", color: "oklch(21.8% 0.036 251.3)", marginBottom: "1rem" }}>Census Records</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[{ year: "1850 Census", count: "16 enslaved people", note: "Listed in slave schedule" }, { year: "1860 Census", count: "12 enslaved people", note: "Listed in slave schedule" }, { year: "1865", count: "Emancipation", note: "Kentucky ratifies 13th Amendment" }, { year: "Post-1865", count: "Several remained", note: "As free domestic workers" }].map(row => (
              <div key={row.year} className="p-4" style={{ background: "oklch(97.8% 0.008 89.6)", border: "1px solid oklch(55% 0.11 72 / 0.2)" }}>
                <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.9rem", color: "oklch(21.8% 0.036 251.3)", fontWeight: 600 }}>{row.year}</p>
                <p style={{ fontFamily: "'EB Garamond', serif", fontSize: "1rem", color: "oklch(47.2% 0.088 247.4)", marginTop: "0.25rem" }}>{row.count}</p>
