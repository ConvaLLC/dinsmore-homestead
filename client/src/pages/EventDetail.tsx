  ...
  return (
    <button
      ...
      style={{
        ...
        border: `2px solid ${selected ? "oklch(34.6% 0.074 256.1)" : isFull ? "oklch(87.6% 0.068 89.7)" : "oklch(87.6% 0.068 89.7)"}`,
        background: selected ? "oklch(34.6% 0.074 256.1)" : isFull ? "oklch(90% 0.02 72)" : "oklch(97.8% 0.008 89.6)",
        color: selected ? "oklch(97.8% 0.008 89.6)" : isFull ? "oklch(60% 0.04 60)" : "oklch(21.8% 0.036 251.3)",
    ...
    >
      ...
      <div style={{ fontFamily: "'EB Garamond', serif", fontSize: "0.75rem", marginTop: "0.3rem",
        color: selected ? "oklch(87.6% 0.068 89.7)" : isFull ? "oklch(50% 0.18 25)" : isLow ? "oklch(52% 0.14 55)" : "oklch(47.2% 0.088 247.4)",
      ...
      {slotPrice > 0 && (
        <div style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.75rem", marginTop: "0.15rem",
          color: selected ? "oklch(87.6% 0.068 89.7)" : "oklch(74.2% 0.118 90.2)" }}>
      ...
      <div className="py-20 text-center">
        <div
          style={{
            width: "40px",
            height: "40px",
            border: "3px solid oklch(87.6% 0.068 89.7)",
            borderTopColor: "oklch(34.6% 0.074 256.1)",
            borderRadius: "50%",
  ...
  if (!event) {
    return (
      <div className="py-20 text-center container">
        <AlertCircle size={48} style={{ color: "oklch(74.2% 0.118 90.2)", margin: "0 auto 1rem" }} />
    ...
    <div>
      ...
      <div className="relative overflow-hidden" style={{ height: "320px" }}>
        ...
        <div className="container relative h-full flex flex-col justify-end pb-10">
          ...
          >
            <Link href="/events" style={{ color: "oklch(87.6% 0.068 89.7)" }}>Events</Link>
            <ChevronRight size={12} />
            <span style={{ color: "oklch(87.6% 0.068 89.7)" }}>{event.title}</span>
          </nav>
          <span
            style={{
          ...
          <h1 style={{ color: "oklch(97.8% 0.008 89.6)", marginBottom: "0.5rem" }}>{event.title}</h1>
          <div
            style={{
              display: "flex",
              gap: "1.5rem",
              ...
              {event.usesTimeslots && timeslots && timeslots.length > 0 && (
                <div className="card-vintage p-6">
                  <div className="flex items-center gap-2 mb-4">
                    <Clock size={18} style={{ color: "oklch(34.6% 0.074 256.1)" }} />
                  ...
                  <div style={{ marginBottom: "1.25rem" }}>
                    <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.7rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "oklch(47.2% 0.088 247.4)", marginBottom: "0.6rem" }}>Step 1 — Choose a Date</p>
                        ...
                        return (
                          <button key={dateKey} onClick={() => { setSelectedDate(dateKey); setSelectedSlot(null); }} disabled={allFull}
                            style={{
                              ...
                              border: `2px solid ${isSelected ? "oklch(34.6% 0.074 256.1)" : allFull ? "oklch(87.6% 0.068 89.7)" : "oklch(87.6% 0.068 89.7)"}`,
                              background: isSelected ? "oklch(34.6% 0.074 256.1)" : allFull ? "oklch(90% 0.02 72)" : "oklch(97.8% 0.008 89.6)",
                              color: isSelected ? "oklch(97.8% 0.008 89.6)" : allFull ? "oklch(60% 0.04 60)" : "oklch(21.8% 0.036 251.3)",
                          ...
                          >
                            ...
                            <div style={{ fontFamily: "'EB Garamond', serif", fontSize: "0.68rem", marginTop: "0.2rem",
                              color: isSelected ? "oklch(87.6% 0.068 89.7)" : allFull ? "oklch(50% 0.18 25)" : "oklch(47.2% 0.088 247.4)",
                  ...
                  {selectedDate && (
                    <div>
                      <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.7rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "oklch(47.2% 0.088 247.4)", marginBottom: "0.6rem" }}>Step 2 — Choose a Time on {format(new Date(selectedDate + "T12:00:00"), "MMMM d, yyyy")}</p>
                      <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
              ...
              >
                ...
                >
                  <div className="flex justify-between mb-1">
                    <span style={{ fontFamily: "'EB Garamond', serif", fontSize: "0.9rem", color: "oklch(47.2% 0.088 247.4)" }}>
