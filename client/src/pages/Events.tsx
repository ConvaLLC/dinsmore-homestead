  ...
  return (
    <div className="relative overflow-hidden" style={{ height: "280px" }}>
      ...
      <div className="container relative h-full flex flex-col justify-end pb-10">
        ...
        <h1 style={{ color: "oklch(96% 0.018 80)", marginBottom: "0.5rem" }}>Events & Programs</h1>
...
export default function EventsPage() {
  ...
  return (
    <div>
      ...
      <section className="py-10" style={{ background: "oklch(96% 0.018 80)" }}>
        <div className="container">
          ...
          <div className="flex items-center gap-3 mb-8 flex-wrap">
            <Filter size={16} style={{ color: "oklch(55% 0.11 72)" }} />
            {EVENT_TYPES.map((type) => (
              <button
                ...
                style={{
                  ...
                  padding: "0.4rem 1rem",
                  border: "1px solid",
                  borderColor: filter === type.value ? "oklch(38% 0.12 22)" : "oklch(72% 0.05 62)",
                  background: filter === type.value ? "oklch(38% 0.12 22)" : "transparent",
                  color: filter === type.value ? "oklch(96% 0.018 80)" : "oklch(46% 0.06 56)",
                  cursor: "pointer",
                  transition: "all 0.2s",
                }}
              >
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div
                  ...
                  style={{ height: "320px", background: "oklch(87% 0.032 72)", animation: "pulse 2s infinite" }}
                />
              ))}
            </div>
            ...
            <div className="text-center py-16">
              <Calendar size={56} style={{ color: "oklch(72% 0.05 62)", margin: "0 auto 1rem" }} />
      ...
      <section
        className="py-12"
        style={{ background: "oklch(27% 0.045 50)", borderTop: "3px solid oklch(55% 0.11 72)" }}
      >
