...
export default function Home() {
  ...
  return (
    <div style={{ background: C.warmWhite }}>
      ...
      {/* ── WHAT'S ON — Upcoming Events Strip ── */}
      <section style={{ background: C.deepNavy, borderBottom: `1px solid ${C.richNavy}` }}>
        <div className="container py-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              <div style={{ width: "3px", height: "28px", background: `linear-gradient(to bottom, ${C.gold}, ${C.goldBright})` }} />
              <div>
                <div
                  style={{
                    fontFamily: "'Cinzel', serif",
            ...
            <Link
              ...
              className="uppercase hover:gap-2"
            >
          ...
          {events && events.length > 0 ? (
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      onMouseEnter={(e) => {
                        (e.currentTarget as HTMLElement).style.borderColor = C.gold;
                        (e.currentTarget as HTMLElement).style.background = `linear-gradient(135deg, ${C.richNavy} 0%, ${C.cobalt}33 100%)`;
                        (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)";
                        (e.currentTarget as HTMLElement).style.boxShadow = `0 8px 24px ${C.midnight}cc`;
                      }}
                      onMouseLeave={(e) => {
                        (e.currentTarget as HTMLElement).style.borderColor = `${C.cobalt}44`;
                    ...
                    >
                      ...
                      <div
                        style={{
                          flexShrink: 0,
                          width: "52px",
                          background: `linear-gradient(135deg, ${C.midnight}, ${C.deepNavy})`,
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          {event.eventType === "tour" ? "Guided Tour" : event.eventType === "fundraiser" ? "Fundraiser" : "Special Event"}
                        </p>
                        <h3
                          style={{
                            fontFamily: "'Playfair Display', serif",
            ...
            <div
              style={{
                textAlign: "center",
                padding: "2.5rem 1rem",
                border: `1px dashed ${C.richNavy}`,
              }}
            >
              <Calendar size={32} style={{ color: C.gold, margin: "0 auto 0.75rem" }} />
              <p
                style={{
                  fontFamily: "'EB Garamond', serif",
                  fontSize: "1.1rem",
