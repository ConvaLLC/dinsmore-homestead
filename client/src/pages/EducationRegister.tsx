              ...
              {step === "done" ? (
                ...
                <div className="card-vintage p-6">
                  <div className="flex items-center gap-2 mb-4">
                    <Mail size={20} style={{ color: "oklch(38% 0.12 22)" }} />
                  ...
                  <p style={{ fontFamily: "'EB Garamond', serif", color: "oklch(46% 0.06 56)", marginBottom: "1rem" }}>
                  ...
                  {!isAuthenticated && (
                    ...
                    >
                      <Lock size={14} style={{ display: "inline", marginRight: "0.4rem", color: "oklch(55% 0.11 72)" }} />
                      You need to{" "}
                      <a href={getLoginUrl()} style={{ color: "oklch(38% 0.12 22)", fontWeight: 600 }}>
                        sign in
                      </a>{" "}
                ...
                <div className="card-vintage p-6">
                  <div className="flex items-center gap-2 mb-4">
                    <BookOpen size={20} style={{ color: "oklch(38% 0.12 22)" }} />
                    <h2 style={{ fontSize: "1.5rem", margin: 0 }}>Request Access</h2>
                  </div>
                  <div style={{ width: "40px", height: "2px", background: "oklch(55% 0.11 72)", marginBottom: "1.25rem" }} />
                  <p style={{ fontFamily: "'EB Garamond', serif", color: "oklch(46% 0.06 56)", marginBottom: "1.25rem" }}>
            ...
            <div className="space-y-6">
              <div className="card-vintage p-5">
                <div className="flex items-center gap-2 mb-3">
                  <BookOpen size={18} style={{ color: "oklch(38% 0.12 22)" }} />
                ...
                <ul style={{ fontFamily: "'EB Garamond', serif", fontSize: "0.95rem", color: "oklch(38% 0.055 54)", paddingLeft: "1.25rem", lineHeight: 1.8 }}>
              ...
              <div className="p-5" style={{ background: "oklch(27% 0.045 50)", borderLeft: "4px solid oklch(55% 0.11 72)" }}>
                <p style={{ fontFamily: "'EB Garamond', serif", fontSize: "0.95rem", color: "oklch(87% 0.032 72)", margin: 0, fontStyle: "italic", lineHeight: 1.7 }}>
