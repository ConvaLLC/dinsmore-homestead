    ...
    <div>
      <div className="relative overflow-hidden" style={{ height: "300px" }}>
        ...
        <div className="container relative h-full flex flex-col justify-end pb-10">
          <span className="section-label" style={{ color: "oklch(74.2% 0.118 90.2)" }}>Private Events</span>
          <h1 style={{ color: "oklch(97.8% 0.008 89.6)" }}>Weddings & Private Events</h1>
        </div>
      </div>
      <section className="py-12" style={{ background: "oklch(97.8% 0.008 89.6)" }}>
        <div className="container max-w-3xl">
          <p style={{ fontFamily: "'EB Garamond', serif", fontSize: "1.1rem", color: "oklch(47.2% 0.088 247.4)", lineHeight: 1.8, marginBottom: "1.5rem" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            {["Intimate Ceremonies", "Garden Receptions", "Corporate Retreats"].map((type) => (
              <div key={type} className="card-vintage p-4 text-center">
                <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.9rem", color: "oklch(21.8% 0.036 251.3)", margin: 0 }}>{type}</p>
              </div>
            ))}
          </div>
          <p style={{ fontFamily: "'EB Garamond', serif", fontSize: "1rem", color: "oklch(47.2% 0.088 247.4)", lineHeight: 1.8, marginBottom: "1.5rem" }}>
