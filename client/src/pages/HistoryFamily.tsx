    ...
    <div className="min-h-screen" style={{ background: "oklch(97.8% 0.008 89.6)" }}>
      ...
      >
        <div className="container">
          <p className="section-label" style={{ color: "oklch(74.2% 0.118 90.2)" }}>The Dinsmore Legacy</p>
          ...
          <nav style={{ fontSize: "0.85rem", color: "oklch(75% 0.03 72)" }}>
            <Link href="/" style={{ color: "oklch(74.2% 0.118 90.2)" }}>Home</Link>
      ...
      {selectedBio && (
        ...
        >
          <div
            ...
            style={{ background: "oklch(97.8% 0.008 89.6)", border: "2px solid oklch(74.2% 0.118 90.2)" }}
            ...
            <div className="p-8">
              <div className="flex items-start gap-6 mb-6">
                <img
                  ...
                  style={{ width: 120, height: 150, border: "3px solid oklch(74.2% 0.118 90.2)", filter: "sepia(20%)" }}
                  onError={e => { (e.target as HTMLImageElement).src = FALLBACK_IMG; }}
                />
                <div>
                  <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.6rem", color: "oklch(21.8% 0.036 251.3)", marginBottom: "0.3rem" }}>
                    {selectedBio.name}
                  </h2>
                  {selectedBio.lifespan && (
                    <p style={{ color: "oklch(74.2% 0.118 90.2)", fontStyle: "italic", marginBottom: "0.5rem" }}>{selectedBio.lifespan}</p>
                  )}
                  <span style={{ display: "inline-block", padding: "2px 10px", fontSize: "0.7rem", letterSpacing: "0.15em", textTransform: "uppercase", background: "oklch(55% 0.11 72 / 0.15)", color: "oklch(74.2% 0.118 90.2)", borderRadius: "2px" }}>
      ...
      <div className="container py-16">
        ...
        <div className="text-center mb-12">
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "2rem", color: "oklch(21.8% 0.036 251.3)", marginBottom: "0.5rem" }}>
            Core Family Members
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {coreBios.map(bio => (
            ...
            >
              <div className="overflow-hidden mb-3" style={{ border: "2px solid oklch(74.2% 0.118 90.2)", aspectRatio: "3/4" }}>
                <img
                  src={getPortrait(bio)}
                  alt={bio.name}
              ...
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.9rem", color: "oklch(21.8% 0.036 251.3)", lineHeight: 1.3 }}
                  className="group-hover:text-[oklch(55%_0.11_72)] transition-colors">
                {bio.name}
              </h3>
              {bio.lifespan && (
                <p style={{ fontSize: "0.75rem", color: "oklch(74.2% 0.118 90.2)", marginTop: "0.2rem", fontStyle: "italic" }}>{bio.lifespan}</p>
              )}
            </button>
          ))}
        </div>
        ...
        <div style={{ borderTop: "1px solid oklch(55% 0.11 72 / 0.3)", paddingTop: "3rem" }}>
          <div className="flex items-center justify-between mb-6">
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.5rem", color: "oklch(21.8% 0.036 251.3)" }}>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.85rem", color: "oklch(21.8% 0.036 251.3)", lineHeight: 1.3 }}
                        className="group-hover:text-[oklch(55%_0.11_72)] transition-colors">
                      {bio.name}
                    </h3>
                    {bio.lifespan && (
                      <p style={{ fontSize: "0.7rem", color: "oklch(74.2% 0.118 90.2)", fontStyle: "italic", marginTop: "0.15rem" }}>{bio.lifespan}</p>
                    )}
                    <p style={{ fontSize: "0.65rem", color: "oklch(50% 0.04 54)", textTransform: "uppercase", letterSpacing: "0.08em", marginTop: "0.25rem" }}>
                      {bio.relation}
                    </p>
                    {bio.shortBio && (
                      <p style={{ fontSize: "0.8rem", color: "oklch(47.2% 0.088 247.4)", marginTop: "0.4rem", lineHeight: 1.5, display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
        ...
        <div style={{ borderTop: "1px solid oklch(55% 0.11 72 / 0.3)", paddingTop: "3rem", marginTop: "3rem" }}>
          <div className="text-center mb-10">
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.8rem", color: "oklch(21.8% 0.036 251.3)", marginBottom: "0.5rem" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div key={v.slug}>
                ...
                <h3 style={{ fontFamily: "'Playfair Display', serif", color: "oklch(21.8% 0.036 251.3)", marginBottom: "0.25rem" }}>{v.title}</h3>
