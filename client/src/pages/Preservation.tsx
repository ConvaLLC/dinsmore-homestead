    ...
    <div>
      <div className="relative overflow-hidden" style={{ height: "280px" }}>
        ...
        <div className="container relative h-full flex flex-col justify-end pb-10">
          <span className="section-label" style={{ color: "oklch(68% 0.12 75)" }}>Our Mission</span>
          <h1 style={{ color: "oklch(96% 0.018 80)" }}>Preservation & Foundation</h1>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            {[
              ...
              <div key={item.title} className="card-vintage p-5">
                ...
                <p style={{ fontFamily: "'EB Garamond', serif", fontSize: "0.9rem", color: "oklch(46% 0.06 56)", margin: 0 }}>{item.desc}</p>
              </div>
            ))}
          </div>
